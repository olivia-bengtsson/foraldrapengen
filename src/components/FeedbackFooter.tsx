      ...
      <div className="bg-white rounded-lg shadow-sm p-8 border border-gray-200">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-white rounded-lg p-6 border-2 border-gray-200 hover:border-green-300 transition-all hover:shadow-md">
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-gray-200 hover:border-green-300 transition-all hover:shadow-md">
              <div className="flex items-start gap-3">
                <div className="p-2 bg-green-100 rounded-lg">
                  <Lightbulb className="text-green-700" size={24} />
                </div>
                <div className="text-left">
                  <h3 className="font-semibold text-gray-800 mb-1">
                    {language === "sv"
          ...
          <button
            ...
            className="group bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-lg transition-all transform hover:scale-105 shadow-sm hover:shadow flex items-center gap-3 mx-auto"
          >
